...
# Built-in Tools
print(DuckDuckGoSearchRun().invoke("AI News."))
CopyFileTool().invoke({'source_path':'./m04-MessagePlaceholder.txt', 'destination_path':'./M13.txt'})
DeleteFileTool().invoke('./M13.txt')
